...
if [file readable ${.RootDir}/Bin/new_scripts.tcl] {
    source ${.RootDir}/Bin/new_scripts.tcl
}
...
### dcp: uplevel strips backslashes in Windows pathnames
#	uplevel "less ${.RootDir}/UserCommands/${command}.txt"
	less "${.RootDir}/UserCommands/${command}.txt"
    } else {
#	uplevel "less ${.RootDir}/Commands/${command}.txt"
	less "${.RootDir}/Commands/${command}.txt"
    }
    return
}
