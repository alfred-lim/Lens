...
extern void print(int minVerbosity, char *fmt, ...);
extern void debug(char *fmt, ...);
extern flag result(char *fmt, ...);
extern flag append(char *fmt, ...);
extern flag warning(char *fmt, ...);
extern int  error(char *fmt, ...);
extern void fatalError(char *fmt, ...);
extern flag eval(char *fmt, ...);
...
extern flag subString(char *a, char *b, int minLength);
...
extern flag readFileIntoString(String S, char *fileName);
extern char *readName(char *list, String name, flag *result);

extern Tcl_Channel readChannel(char *fileName);
extern Tcl_Channel writeChannel(char *fileName, flag append);
...
extern flag sendString(Tcl_Channel channel, char *s);
...
// dcp
extern real addHalfGaussianNoise(real value, real range);
extern real addHalfUniformNoise(real value, real range);
