...
static void initNetInfo(void) {
  ...
  addMember(NetInfo, "error", OBJ, OFFSET(N, error), TRUE, 
	    0, 0, RealInfo);
  addMember(NetInfo, "exampleError", OBJ, OFFSET(N, exampleError), TRUE, 
	    0, 0, RealInfo);
  ...
  addMember(NetInfo, "groupCritRequired", OBJ, OFFSET(N, groupCritRequired), 
	    TRUE, 0, 0, FlagInfo);
  // dcp
  addMember(NetInfo, "parallelLoadBalance", OBJ, OFFSET(N, parallelLoadBalance), 
	    TRUE, 0, 0, FlagInfo);
  ...
  addMember(NetInfo, "outputGain", OBJ, OFFSET(N, outputGain), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "integratedOutputTau", OBJ, OFFSET(N, integratedOutputTau), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "integratedOutputDecay", OBJ, OFFSET(N, integratedOutputDecay), TRUE,
	    0, 0, RealInfo);
  addMember(NetInfo, "lastFeedforwardGroupNum", OBJ, OFFSET(N, lastFeedforwardGroupNum), TRUE,
	    0, 0, IntInfo);
  ...
  addMember(NetInfo, "noiseRange", OBJ, OFFSET(N, noiseRange), TRUE, 
	    0, 0, RealInfo);
  addMember(NetInfo, "dropoutProb", OBJ, OFFSET(N, dropoutProb), TRUE, 
	    0, 0, RealInfo);
  addSpacer(NetInfo);
...
static void initGroupInfo(void) {
  ...
  addMember(GroupInfo, "elbowLowerSlope", OBJ, OFFSET(G, elbowLowerSlope), TRUE, 0,0, RealInfo);
  addMember(GroupInfo, "elbowUpperSlope", OBJ, OFFSET(G, elbowUpperSlope), TRUE, 0,0, RealInfo);
  ...
  addMember(GroupInfo, "outputGain", OBJ, OFFSET(G, outputGain), TRUE,
	    0, 0, RealInfo);
  addMember(GroupInfo, "noZeroInputNoise", OBJ, OFFSET(G, noZeroInputNoise), TRUE,
	    0, 0, FlagInfo);
  addMember(GroupInfo, "applyNoiseOnce", OBJ, OFFSET(G, applyNoiseOnce), TRUE,
	    0, 0, FlagInfo);
  addMember(GroupInfo, "integratedOutputTau", OBJ, OFFSET(G, integratedOutputTau), TRUE,
	    0, 0, RealInfo);
  addMember(GroupInfo, "integratedOutputDecay", OBJ, OFFSET(G, integratedOutputDecay), TRUE,
	    0, 0, RealInfo);
  ...
  addMember(GroupInfo, "noiseRange", OBJ, OFFSET(G, noiseRange), TRUE, 
	    0, 0, RealInfo);
  addMember(GroupInfo, "dropoutProb", OBJ, OFFSET(G, dropoutProb), TRUE, 
	    0, 0, RealInfo);
  addSpacer(GroupInfo);
  ...
  addMember(GroupInfo, "numColumns", OBJ, OFFSET(G, numColumns),
	    TRUE, 0, 0, IntInfo);
  addMember(GroupInfo, "k", OBJ, OFFSET(G, k),
	    TRUE, 0, 0, IntInfo);
  addMember(GroupInfo, "mismatchCriterion", OBJ, OFFSET(G, mismatchCriterion),
	    TRUE, 0, 0, RealInfo);
  addMember(GroupInfo, "mismatchPenalty", OBJ, OFFSET(G, mismatchPenalty),
	    TRUE, 0, 0, RealInfo);
...
static void initUnitInfo(void) {
  ...
  addMember(UnitInfo, "dtScale", OBJ, OFFSET(U, dtScale), TRUE, 
	    0, 0, RealInfo);
  addMember(UnitInfo, "integratedOutput", OBJ, OFFSET(U, integratedOutput), TRUE, 
	    0, 0, RealInfo);
  ...
  addMember(UnitInfo, "plotCol", OBJ, OFFSET(U, plotCol), FALSE, 
	    0, 0, IntInfo);
//sl
  addMember(UnitInfo, "activeTicks", OBJ, OFFSET(U, activeTicks), TRUE, 0,0,  IntInfo);
}
...
static void initExampleSetInfo(void) {
  ...
  addMember(ExampleSetInfo, "graceTime", OBJ, OFFSET(S, graceTime), 
	    TRUE, 0, 0, RealInfo);
  addMember(ExampleSetInfo, "regraceTime", OBJ, OFFSET(S, regraceTime), 
	    TRUE, 0, 0, RealInfo);
...
static void initExampleInfo(void) {
  ...
  addMember(ExampleInfo, "probability", OBJ, OFFSET(E, probability), FALSE, 
	    0, 0, RealInfo);
  addMember(ExampleInfo, "error", OBJ, OFFSET(E, error), FALSE, 
	    0, 0, RealInfo);
  addMember(ExampleInfo, "critReached", OBJ, OFFSET(E, critReached), TRUE,
	    0, 0, FlagInfo);
  addMember(ExampleInfo, "currentEventNum", OBJ, OFFSET(E, currentEventNum), TRUE,
	    0, 0, IntInfo);
...
static void eventName(void *event, char *dest) {
  ...
  if (V) {
    ...
    dest += shift;
    if (isNaN(V->regraceTime)) sprintf(dest, "%s %n", NO_VALUE, &shift);
    else sprintf(dest, "%g %n", V->regraceTime, &shift);
    dest += shift;
  } else dest[0] = '\0';
}
...
static void initEventInfo(void) {
  ...
  addMember(EventInfo, "graceTime", OBJ, OFFSET(V, graceTime), TRUE,
	    0, 0, RealInfo);
  addMember(EventInfo, "regraceTime", OBJ, OFFSET(V, regraceTime), TRUE,
	    0, 0, RealInfo);
  addMember(EventInfo, "critReached", OBJ, OFFSET(V, critReached), TRUE,
	    0, 0, FlagInfo);
