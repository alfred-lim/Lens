...
#define DEF_G_dropoutProb         NaN

#define DEF_G_showIncoming        TRUE
#define DEF_G_showOutgoing        TRUE
#define DEF_G_numColumns          0
#define DEF_G_k		          1
#define DEF_G_mismatchCriterion   1.0
#define DEF_G_mismatchPenalty	  1.0
